...
def train_baseline(
    ...
    # DataLoader settings help performance on GPU, while staying safe on CPU.
    ...
    # - If you oversample, you typically do NOT want an additional pos_weight.
    # - If you do not oversample, pos_weight is useful.
    if use_pos_weight:
