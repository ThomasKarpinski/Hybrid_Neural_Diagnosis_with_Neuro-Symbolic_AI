    ...
    for gen in range(1, generations + 1):
        ...
        for i in range(pop_size):
            ...
            if gen == 1 and "score" not in target:
                ...
                res_t = train_and_eval_on_val(hparams_t, X_train, y_train, X_val, y_val, input_dim, seed=seed+i, device=device)
            ...
            res_trial = train_and_eval_on_val(hparams_trial, X_train, y_train, X_val, y_val, input_dim, seed=seed+gen*pop_size+i, device=device)
